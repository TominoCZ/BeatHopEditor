...
If none of these work or this error was thrown while the editor was already running, report the error in the official Sound Space or Beat Hop Discord server to attempt to resolve the issue if possible.
                ";
