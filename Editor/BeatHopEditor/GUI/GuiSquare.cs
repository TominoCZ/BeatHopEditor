...
namespace BeatHopEditor.GUI
{
    internal class GuiSquare : WindowControl
    {
        ...
        public GuiSquare(float posx, float posy, float sizex, float sizey, Color color, bool outline = false, string fileName = "", string textureName = "", bool maintainRatio = false) : base(posx, posy, sizex, sizey)
        {
            Color = color;
            prevColor = Color;
            Outline = outline;
