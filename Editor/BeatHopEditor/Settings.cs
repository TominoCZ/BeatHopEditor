...
namespace BeatHopEditor
{
    internal class Settings
    {
        public static Dictionary<string, dynamic> settings = new()
        {
            ...
            {"quantumSnapping", new SliderSetting(0f, 15f, 1f) },

            {"changelogPosition", new SliderSetting(0f, 0f, 1f) },

            {"tweenFunction", new ListSetting("linear", "linear", "sine", "quadratic", "cubic") },
            {"tweenMode", new ListSetting("in/out", "in/out", "in", "out") },
            ...
            {"gridKeys", new List<Keys> { Keys.Q, Keys.W, Keys.E, Keys.R, Keys.T } },
        ...
        public static void RefreshKeyMapping()
        {
            ...
            for (int i = 0; i < 5; i++)
                MainWindow.Instance.KeyMapping.Add(settings["gridKeys"][i], i);
        }
